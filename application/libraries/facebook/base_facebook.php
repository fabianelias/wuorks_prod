...
abstract class BaseFacebook
{
  ...
  protected function getUserFromAccessToken() {
    try {
      $user_info = $this->api('/me?locale=en_US&fields=name,email,id');//indico la cantidad de informació que requiero
   ...
   * @return mixed
   */
  abstract protected function getPersistentData($key, $default = true);
